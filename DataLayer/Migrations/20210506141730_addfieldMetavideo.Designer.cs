...
namespace DataLayer.Migrations
{
    ...
    [Migration("20210506141730_addfieldMetavideo")]
    partial class addfieldMetavideo
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataLayer.EF.BusinessOwner", b =>
                {
                    ...
                    b.Property<int>("TypeShippingBussinessOwner")
                        .HasColumnName("TypeShippingBussinessOwner")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DataLayer.EF.Invoice", b =>
                {
                    ...
                    b.Property<short>("ProcessingDays")
                        .HasColumnType("smallint");
            ...
            modelBuilder.Entity("DataLayer.EF.Product", b =>
                {
                    ...
                    b.Property<float>("CalculatedStar")
                        .HasColumnName("CalculatedStar")
                        .HasColumnType("real");
                    ...
                    b.HasIndex("NameForUrll")
                        .IsUnique()
                        .HasName("IX_NameForUrll")
                        .HasFilter("[NameForUrll] IS NOT NULL");
            ...
            modelBuilder.Entity("DataLayer.EF.Wish", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
