$(document).ready(function () {
    $('#datePicker1').click(function () { $('#ctl00_cphLeft_txtStartDate').focus(); });
    $('#datePicker2').click(function () { $('#ctl00_cphLeft_txtEndDate').focus(); });
    $('#ctl00_cphLeft_txtStartDate').calendarsPicker({ calendar: $.calendars.instance('persian', "fa"), dateFormat: 'yyyy/mm/dd' });
    $('#ctl00_cphLeft_txtEndDate').calendarsPicker({ calendar: $.calendars.instance('persian', "fa"), dateFormat: 'yyyy/mm/dd' });
    $('#datePicker3').click(function () { $('#ctl00_cphLeft_txtFixDate').focus(); });
    $('#ctl00_cphLeft_txtFixDate').calendarsPicker({ calendar: $.calendars.instance('persian', "fa"), dateFormat: 'yyyy/mm/dd' });
    $('#datePicker4').click(function () { $('#ctl00_cphLeft_txtExpireDate').focus(); });
    $('#ctl00_cphLeft_txtExpireDate').calendarsPicker({ calendar: $.calendars.instance('persian', "fa"), dateFormat: 'yyyy/mm/dd' });
});
    ...
    function CalendarsPicker() {
        ...
        this.regional = {
            '': {
                ...
                prevText: 'قبلی &gt;', // Text for the previous month command -- &lt;Prev
                prevStatus: 'نمایش ماه قبل', // Status text for the previous month command --'Show the previous month'
                prevJumpText: '&lt;&lt;', // Text for the previous year command
                prevJumpStatus: 'نمایش سال قبل', // Status text for the previous year command--Show the previous year
                nextText: '&lt; بعدی ', // Text for the next month command -- Next
                nextStatus: 'نمایش ماه بعد', // Status text for the next month command
                nextJumpText: '&gt;&gt;', // Text for the next year command
                nextJumpStatus: 'نمایش سال بعد', // Status text for the next year command
                currentText: 'جاری', // Text for the current month command
                currentStatus: 'نمایش ماه جاری', // Status text for the current month command
                todayText: 'امروز', // Text for the today's month command
                todayStatus: 'امروز را نشان بده', // Status text for the today's month command
                clearText: 'پاک کردن', // Text for the clear command
                clearStatus: 'تمام تاریخها پاک میشوند', // Status text for the clear command
                closeText: 'بستن', // Text for the close command
                closeStatus: 'بستن تقویم', // Status text for the close command
                yearStatus: 'تغییر سال', // Status text for year selection
                monthStatus: 'تغییر ماه', // Status text for month selection
                weekText: 'Wk', // Text for week of the year column header
                weekStatus: 'Week of the year', // Status text for week of the year column header
                dayStatus: 'انتخاب DD, M d, yyyy', // Status text for selectable days
